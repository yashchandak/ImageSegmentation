...
int textureDifference2(Vec4b p1, Vec4b p2)
{
...
int farTextureDifference2(Vec4b p1, Vec4b p2)
{
...
bool similar2(Vec3b now, Vec3b actual)
{
    //20 60 60
...
bool farPtSimilar2(Vec3b next, Vec3b curr)
{
    //2 5 5
...
bool similar(Vec3b now, Vec3b actual)
{
    //20 60 60
...
bool farPtSimilar(Vec3b next, Vec3b curr)
{
    //2 5 5
...
Mat generateTexture(Mat gradient, int windowSize = 20)
{
...
int ifSimilar(Vec4b nextTexture,Vec4b seedTexture, Vec4b currTexture,
              ...
              int nextTotalPixels, int seedTotalPixels, int currTotalPixels)
{
...
pair<Mat, vector<pair<pair<Point, Vec3b>, int > > > colSeg(Mat image)//random col segment
{
...
int main()
{
    //Mat image= imread("D:/ToDo/2Dto3D/toolbox_nyu_depth_v2/Image_data/1021.png",1);//"Textured1.jpg",1);
    Mat image= imread("C:/Users/yash/Pictures/Sample Pictures/Penguins.jpg",1);
    //Mat image= imread("Textured1.jpg",1);
    ...
    //regionMerge(texture, retVal, image);
    //printAtan();
    waitKey(0);
    return 0;
}
